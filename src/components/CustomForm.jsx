...
function CustomForm({ mode, name, route }) {
  ...
  useEffect(() => {
    const getThreeFiveSixData = async () => {
      const response = await fetch(`http://localhost:3000/v1/${route}/${id}`);
    ...
    <>
      <div className="p-4">
        ...
        <div className="flex my-8">
          <h2 className="text-xl font-sans font-semibold">{name} Form</h2>
